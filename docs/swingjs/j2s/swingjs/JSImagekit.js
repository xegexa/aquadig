...
Clazz.newMeth(C$, 'getMediaInfoAsync$BA$S$S$java_util_function_Consumer$java_util_function_Consumer',  function (data, trackType, path, success, onError) {
...
(function(){/*m*/var C$=Clazz.newClass(P$, "JSImagekit$lambda1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'Runnable', 1);
...
), Clazz.new_(P$.JSImagekit$lambda1.$init$,[this, {trackType:trackType,data:data,onError:onError,success:success}]))]);
return;
}var f;
if (C$.mediaInfoObject == null ) {
f=((P$.JSImagekit$1||
(function(){/*a*/var C$=Clazz.newClass(P$, "JSImagekit$1", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Consumer', 1);
...
Clazz.newMeth(C$, 'accept$O',  function (mediainfo) {
$I$(9).mediaInfoObject=mediainfo;
$I$(9).getMediaInfoAsync$BA$S$S$java_util_function_Consumer$java_util_function_Consumer(this.$finals$.data, null, this.$finals$.trackType, this.$finals$.success, this.$finals$.onError);
});
})()
), Clazz.new_(P$.JSImagekit$1.$init$,[this, {trackType:trackType,data:data,onError:onError,success:success}]));

MediaInfo.mediaInfoFactory( { format: 'JSON' }, function(mediainfo){ f.accept$O(mediainfo) } );
return;
}f=((P$.JSImagekit$2||
(function(){/*a*/var C$=Clazz.newClass(P$, "JSImagekit$2", function(){Clazz.newInstance(this, arguments[0],1,C$);}, null, 'java.util.function.Consumer', 1);
...
Clazz.newMeth(C$, 'accept$O',  function (result) {
try {
var info=null;
...
), Clazz.new_(P$.JSImagekit$2.$init$,[this, {trackType:trackType,onError:onError,success:success}]));
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:38 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
