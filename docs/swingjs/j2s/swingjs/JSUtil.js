...
), Clazz.new_(P$.JSUtil$1.$init$,[this, {handler:handler,c:c}]));
var f=null;
...
Clazz.newMeth(C$, 'loadScriptAsync$S$Runnable',  function (url, success) {
var u;
try {
u=Clazz.new_($I$(2,1).c$$S,[url]);
var f=function(){success.run$()} ||null;
C$.setAjax$OA(Clazz.array(java.lang.Object, -1, ["url", u, "url", url, "dataType", "script", "success", f]));
u.getContent$();
} catch (e) {
if (Clazz.exceptionOf(e,"Exception")){
e.printStackTrace$();
...
;Clazz.setTVer('5.0.1-v7');//Created 2025-12-19 08:25:39 Java2ScriptVisitor version 5.0.1-v7 net.sf.j2s.core.jar version 5.0.1-v7
